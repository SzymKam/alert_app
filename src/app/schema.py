...
#
#     def mutate(self, info, first_name, last_name, medical_qualifications, is_driver,
#                has_vehicle_driving_privileges, is_navigator, is_planner):
...
#
#     def mutate(self, info, first_name, last_name, medical_qualifications, is_driver,
#                has_vehicle_driving_privileges, is_navigator, is_planner, id):
